...
} from "../../../../lib/rules/computer-science-degree.ts";
import {
...
type CustomComputerSciencePlanCheckInput = {
  courseCodes: string[];
...
export async function GET() {
  ...
  return Response.json(
    buildComputerSciencePlanCheck({
      courseCodes: getDegreeWorksPlanSampleCourseCodes(),
      planDescription: plan.planDescription,
      major: "Computer Science",
      program: computerScienceDegreeRule.program,
...
export async function POST(request: Request) {
  ...
  return Response.json(buildComputerSciencePlanCheck(validation.input));
}

function buildComputerSciencePlanCheck({
  courseCodes,
  major,
  planDescription,
  program,
  totalPlannedCredits,
}: CustomComputerSciencePlanCheckInput) {
...
function parseCustomPlanCheckRequest(body: unknown) {
  ...
  return {
    ...
    input: {
      ...
      major: readOptionalString(body.major, "Computer Science"),
      program: computerScienceDegreeRule.program,
